...
def analyze_cognitive_seo(url):
    ...
    categories.append({
        ...
        "bias_explain": "Imagine : tu pousses la porte d'un magasin, mais elle met 5 secondes à s'ouvrir. Tu fais demi-tour. C'est exactement ce qui se passe sur un site lent. Au-delà de 3 secondes, le cerveau perçoit le site comme une menace et il fuit. Amazon a mesuré que chaque 100ms de chargement en plus leur coûtait 1% de ventes.",
        "score": speed_score,
        "max": 10,
    ...
    categories.append({
        ...
        "bias_explain": "C'est comme la vitrine d'un magasin. Si l'affiche en gros dit 'Soldes -50%', tu rentres. Si elle dit juste 'Magasin de vêtements', tu passes. Ton H1, c'est cette affiche. Le cerveau le lit en premier et décide en 3 secondes si ta page vaut le coup. Exemple : 'Plombier Besançon' → bof. 'Fuite d'eau ? Plombier à Besançon en 30 min' → le cerveau réagit.",
        "score": h1_score,
        "max": 10,
        "details": h1_details,
    ...
    categories.append({
        ...
        "bias_explain": "Quand tu roules sur l'autoroute, tu lis les panneaux en 1 seconde. Ton meta title c'est pareil : c'est ce que les gens voient dans Google avant de cliquer. Exemple concret : 'Nos services' → personne clique. 'Évitez ces 5 erreurs qui plombent votre site' → le cerveau réagit 2x plus fort à la peur de perdre qu'à l'envie de gagner.",
        "score": title_score,
        "max": 10,
    ...
    categories.append({
        ...
        "bias_explain": "C'est le petit texte sous le titre dans Google. Comme le résumé au dos d'un livre : si ça te parle pas, tu reposes le livre. Exemple : 'Nous proposons des services de qualité' → rien ne se passe. 'Ton site est invisible sur Google ? Diagnostic gratuit en 30 min' → là, le cerveau se dit 'c'est pour moi' et il clique.",
        "score": desc_score,
        "max": 10,
    ...
    categories.append({
        ...
        "bias_explain": "Imagine deux restaurants. L'un a un menu clair avec 3 catégories. L'autre a 4 pages de plats sans ordre. Tu choisis lequel ? Le premier. Ton site c'est pareil. Quand c'est bien structuré (titres, sous-titres, listes), le cerveau trouve ça plus crédible et plus facile à lire. Il reste plus longtemps.",
        "score": struct_score,
        "max": 10,
    ...
    categories.append({
        ...
        "icon": "👥",
        "bias": "Preuve sociale",
        "bias_explain": "Tu passes devant 2 restaurants. L'un est plein, l'autre est vide. Tu choisis lequel ? Le plein. Même si la bouffe est meilleure dans l'autre. C'est la preuve sociale : quand d'autres font confiance, ton cerveau suit. Sur un site : des avis clients, des chiffres ('47 entreprises accompagnées'), des logos partenaires → tout ça dit au cerveau 'c'est sûr'.",
        "score": social_score,
        "max": 10,
    ...
    categories.append({
        ...
        "bias_explain": "T'es dans un magasin. Un vendeur te dit 'Le rayon est là-bas, les promos sont ici, le catalogue est sur le comptoir, appelez-nous, envoyez un mail'. Tu fais quoi ? Rien. Tu pars. Trop de choix tue le choix. Sur un site, c'est pareil : UN bouton clair ('Demander un devis gratuit') convertit mieux que 10 liens différents.",
        "score": cta_score,
        "max": 10,
        "details": cta_details,
    ...
    categories.append({
        ...
        "bias_explain": "Ouvre un journal. Tes yeux vont où en premier ? Sur la photo. Pas sur le texte. Le cerveau traite les images 60 000x plus vite que le texte. Sur un site web, une page sans image c'est comme un article de journal sans photo : le cerveau passe à côté. Et les images sans alt text sont invisibles pour Google.",
        "score": img_score,
        "max": 10,
        "details": img_details,
    ...
    categories.append({
        ...
        "icon": "🔗",
        "bias": "Fluidité cognitive",
        "bias_explain": "Imagine une librairie. Tu lis la 4ème de couv' d'un roman policier. À côté, il y a un panneau 'Si vous aimez ça, vous aimerez aussi...' avec 3 autres livres. Tu en prends un. C'est le maillage interne : des liens dans tes textes qui guident le visiteur vers d'autres pages. Sans ça, il lit une page et repart. Avec, il explore ton site.",
        "score": link_score,
        "max": 10,
    ...
    categories.append({
        ...
        "bias_explain": "Dans une page de résultats Google, tous les sites se ressemblent : titre bleu, description grise. Mais certains affichent des étoiles ⭐⭐⭐⭐⭐, des prix, des FAQ dépliables. Ils prennent 2x plus de place visuellement. L'œil est attiré en premier. C'est comme un stand au marché avec une belle déco vs un stand vide : tu t'arrêtes devant le beau.",
        "score": schema_score,
        "max": 10,
    ...
    categories.append({
        ...
        "bias_explain": "70% de tes visiteurs sont sur leur téléphone. Et sur mobile, la patience est encore plus courte. C'est comme faire la queue au drive : si ça avance pas en 10 secondes, tu râles. Un bouton trop petit pour le pouce, un texte illisible sans zoomer, un site qui charge en 5 secondes → le cerveau mobile dit 'suivant' et part chez ton concurrent.",
        "score": mobile_score,
        "max": 10,
    ...
    categories.append({
        ...
        "bias_explain": "Tu reçois un courrier d'une entreprise sans adresse, sans téléphone, sans nom. Tu fais confiance ? Non. Ton site c'est pareil. Le cerveau cherche des preuves qu'un HUMAIN est derrière : un numéro de téléphone cliquable, une adresse physique, un visage. Le plombier de Besançon rassure plus que 'ServicePlomberie.com' sans localisation.",
        "score": trust_score,
        "max": 10,
    ...
    categories.append({
        ...
        "bias_explain": "Exemple concret : tu vas sur un site de plombier. En haut : 'Devis gratuit en 2 min'. Au milieu : 'Appelez maintenant'. En bas : 'Diagnostic offert'. Ça, c'est clair — le cerveau sait quoi faire. Maintenant compare avec un site qui a juste 'En savoir plus' caché en bas de page. Personne clique. Le CTA doit être visible, avec un verbe d'action et un bénéfice.",
        "score": cta2_score,
        "max": 10,
    ...
    categories.append({
        ...
        "bias_explain": "C'est comme le sommaire d'un livre. Si tu ouvres un bouquin et que le sommaire dit 'Chapitre 1, Chapitre 2, Chapitre 3' → tu sais pas de quoi ça parle. Si c'est 'Comment éviter les arnaques', 'Les 3 erreurs fatales', 'Guide pas à pas' → t'as envie de lire. Tes H2 c'est ton sommaire. Le cerveau les scanne en 3 secondes pour décider s'il reste.",
        "score": tag_score,
        "max": 10,
        "details": tag_details,
