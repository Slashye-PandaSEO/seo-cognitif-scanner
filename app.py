...
def analyze_cognitive_seo(url):
    ...
    categories.append({
        ...
        "bias_explain": "Imagine : tu pousses la porte d'un magasin, mais elle met 5 secondes à s'ouvrir. Tu fais demi-tour. C'est pareil sur un site lent. Amazon a mesuré que 100ms de chargement en plus = 1% de ventes en moins.<br><br>💡 <strong>Exemple à suivre :</strong> Passe tes images de PNG (2 Mo) à WebP (200 Ko) avec squoosh.app. Un site qui chargeait en 6s est passé à 1.8s juste en compressant les images.",
        "score": speed_score,
        "max": 10,
    ...
    categories.append({
        ...
        "bias_explain": "C'est comme la vitrine d'un magasin. Si l'affiche dit 'Soldes -50%', tu rentres. Si elle dit juste 'Magasin de vêtements', tu passes.<br><br>💡 <strong>Exemple à suivre :</strong><br>❌ Avant : 'Plombier Besançon'<br>✅ Après : 'Fuite d'eau ? Plombier à Besançon — intervention en 30 min'<br>Le cerveau réagit à un problème concret + une promesse, pas à un mot-clé sec.",
        "score": h1_score,
        "max": 10,
        "details": h1_details,
    ...
    categories.append({
        ...
        "bias_explain": "Quand tu roules sur l'autoroute, tu lis les panneaux en 1 seconde. Ton meta title, c'est ce panneau dans les résultats Google.<br><br>💡 <strong>Exemple à suivre :</strong><br>❌ Avant : 'Nos services | MonEntreprise'<br>✅ Après : 'Évitez ces 5 erreurs SEO qui vous coûtent des clients | MonEntreprise'<br>Le cerveau réagit 2x plus fort à la peur de perdre qu'à l'envie de gagner.",
        "score": title_score,
        "max": 10,
    ...
    categories.append({
        ...
        "bias_explain": "C'est le petit texte sous le titre dans Google. Comme le résumé au dos d'un livre : si ça te parle pas, tu reposes le livre.<br><br>💡 <strong>Exemple à suivre :</strong><br>❌ Avant : 'Nous proposons des services de qualité pour votre entreprise'<br>✅ Après : 'Ton site est invisible sur Google ? Diagnostic gratuit en 30 min — résultats concrets'<br>La question interpelle, le gratuit active la réciprocité, la promesse rassure.",
        "score": desc_score,
        "max": 10,
    ...
    categories.append({
        ...
        "bias_explain": "Imagine deux restaurants. L'un a un menu clair avec 3 catégories. L'autre a 4 pages de plats sans ordre. Tu choisis lequel ? Le premier.<br><br>💡 <strong>Exemple à suivre :</strong><br>❌ Avant : un bloc de texte de 500 mots sans aucun titre<br>✅ Après : H2 'Pourquoi choisir un plombier local ?', H2 'Nos tarifs', H2 'Comment ça marche ?', H3 'Étape 1'...<br>Le cerveau scanne les titres en 3 secondes. Si c'est clair, il lit. Sinon, il part.",
        "score": struct_score,
        "max": 10,
    ...
    categories.append({
        ...
        "icon": "👥",
        "bias": "Preuve sociale",
        "bias_explain": "Tu passes devant 2 restaurants. L'un est plein, l'autre est vide. Tu vas dans lequel ? Le plein. Même si la bouffe est meilleure dans l'autre.<br><br>💡 <strong>Exemple à suivre :</strong><br>❌ Avant : aucun avis, aucun chiffre, aucun logo client<br>✅ Après : '⭐⭐⭐⭐⭐ 47 entreprises accompagnées' + 3 témoignages avec prénom et photo + logos partenaires<br>Chaque élément de preuve dit au cerveau 'tu peux faire confiance'.",
        "score": social_score,
        "max": 10,
    ...
    categories.append({
        ...
        "bias_explain": "T'es dans un magasin. Un vendeur te dit 'Le rayon est là-bas, les promos sont ici, le catalogue est sur le comptoir, appelez-nous, envoyez un mail'. Tu fais quoi ? Rien. Tu pars.<br><br>💡 <strong>Exemple à suivre :</strong><br>❌ Avant : 'En savoir plus' caché en bas de page<br>✅ Après : un gros bouton en haut 'Demander mon devis gratuit →' + le même bouton en bas de page<br>UN verbe d'action + UN bénéfice + visible sans scroller.",
        "score": cta_score,
        "max": 10,
        "details": cta_details,
    ...
    categories.append({
        ...
        "bias_explain": "Ouvre un journal. Tes yeux vont où en premier ? Sur la photo. Le cerveau traite les images 60 000x plus vite que le texte.<br><br>💡 <strong>Exemple à suivre :</strong><br>❌ Avant : une page de texte sans aucune image<br>✅ Après : 1 image par section — photo équipe, screenshot résultat, infographie, photo produit<br>Et chaque image avec un alt text descriptif (pas 'image1.jpg' mais 'audit-seo-besancon-panda-seo').",
        "score": img_score,
        "max": 10,
        "details": img_details,
    ...
    categories.append({
        ...
        "icon": "🔗",
        "bias": "Fluidité cognitive",
        "bias_explain": "Imagine une librairie. Tu lis la 4ème de couv' d'un polar. À côté : 'Si vous aimez ça, vous aimerez aussi...' Tu en prends un autre. C'est le maillage interne.<br><br>💡 <strong>Exemple à suivre :</strong><br>❌ Avant : ton article 'Audit SEO' ne mentionne aucune autre page<br>✅ Après : dans l'article, tu ajoutes 'Découvrez aussi notre guide sur l'optimisation technique' avec un lien<br>3 à 5 liens internes par page vers tes pages stratégiques.",
        "score": link_score,
        "max": 10,
    ...
    categories.append({
        ...
        "bias_explain": "Dans Google, tous les résultats se ressemblent : titre bleu, description grise. Mais certains affichent des étoiles ⭐⭐⭐⭐⭐, des prix, des FAQ. Ils prennent 2x plus de place.<br><br>💡 <strong>Exemple à suivre :</strong><br>❌ Avant : résultat Google basique (titre + description)<br>✅ Après : ajoute le schéma FAQPage → tes questions/réponses s'affichent directement dans Google. Ajoute LocalBusiness → ton adresse et téléphone apparaissent<br>Teste sur search.google.com/test/rich-results",
        "score": schema_score,
        "max": 10,
    ...
    categories.append({
        ...
        "bias_explain": "70% de tes visiteurs sont sur mobile. C'est comme faire la queue au drive : si ça avance pas en 10 secondes, tu râles.<br><br>💡 <strong>Exemple à suivre :</strong><br>❌ Avant : texte minuscule, boutons trop petits, images qui débordent<br>✅ Après : teste ton site sur ton téléphone. Le bouton CTA est cliquable avec le pouce ? Le texte se lit sans zoomer ? La page charge en moins de 3 secondes ?<br>Si non, c'est la priorité n°1.",
        "score": mobile_score,
        "max": 10,
    ...
    categories.append({
        ...
        "bias_explain": "Tu reçois un courrier d'une entreprise sans adresse, sans téléphone, sans nom. Tu fais confiance ? Non.<br><br>💡 <strong>Exemple à suivre :</strong><br>❌ Avant : un site sans coordonnées, juste un formulaire de contact<br>✅ Après : téléphone cliquable dans le header (06 XX XX XX XX), adresse dans le footer, photo de l'équipe sur la page 'Qui sommes-nous', badge HTTPS visible<br>Chaque détail dit au cerveau 'un vrai humain est derrière'.",
        "score": trust_score,
        "max": 10,
    ...
    categories.append({
        ...
        "bias_explain": "Tu vas sur un site de plombier. En haut : 'Devis gratuit en 2 min'. Au milieu : 'Appelez maintenant'. En bas : 'Diagnostic offert'. Le cerveau sait quoi faire.<br><br>💡 <strong>Exemple à suivre :</strong><br>❌ Avant : 'En savoir plus' (vague, pas d'urgence)<br>✅ Après : 'Obtenir mon diagnostic gratuit →' (verbe d'action + bénéfice + flèche)<br>Et place-le en haut de page ET en bas. Le cerveau décide vite — le CTA doit être là quand il est prêt.",
        "score": cta2_score,
        "max": 10,
    ...
    categories.append({
        ...
        "bias_explain": "C'est comme le sommaire d'un livre. 'Chapitre 1, Chapitre 2' → tu sais pas de quoi ça parle. 'Comment éviter les arnaques', 'Les 3 erreurs fatales' → t'as envie de lire.<br><br>💡 <strong>Exemple à suivre :</strong><br>❌ Avant : H2 'Nos services', H2 'À propos', H2 'Contact'<br>✅ Après : H2 'Comment booster ton trafic en 3 mois', H2 'Les 5 erreurs qui plombent ton SEO', H2 'Pourquoi le SEO local est une mine d'or'<br>Tes H2 doivent donner envie de lire, pas juste décrire une section.",
        "score": tag_score,
        "max": 10,
        "details": tag_details,
